...
CREATE TABLE IF NOT EXISTS `STMVendorer_db`.`zamówienia_towary` (
  ...
  INDEX `zamówienia_towary_towary` (`fk_towary` ASC),
...
CREATE TABLE IF NOT EXISTS `STMVendorer_db`.`kategorie` (
  ...
  `fk_podkategorii` INT(11) NULL DEFAULT NULL,
  UNIQUE INDEX (`kategoria` ASC),
  UNIQUE INDEX (`fk_podkategorii` ASC),
  PRIMARY KEY (`pk`),
...
CREATE TABLE IF NOT EXISTS `STMVendorer_db`.`towary_kategorie` (
  `pk` INT(11) NOT NULL AUTO_INCREMENT,
  `fk_towary` INT(10) NOT NULL,
  `fk_kategorie_towaru` INT(11) NOT NULL,
  PRIMARY KEY (`pk`),
  INDEX `towary_towary_kategorie` (`fk_towary` ASC),
  INDEX `kategorie_towary_kategorie` (`fk_kategorie_towaru` ASC),
  CONSTRAINT `towary_towary_kategorie`
    FOREIGN KEY (`fk_towary`)
    REFERENCES `STMVendorer_db`.`towary` (`pk`),
  CONSTRAINT `kategorie_towary_kategorie`
    FOREIGN KEY (`fk_kategorie_towaru`)
    REFERENCES `STMVendorer_db`.`kategorie` (`pk`)
  ) ENGINE = InnoDB;
COMMIT;
...
INSERT INTO `dostawcy` (pk,miejscowość,ulica,numer_mieszkania,kod_pocztowy,gmina,powiat,województwo,nazwa,nip,login,hashowane_haslo) VALUES
...
INSERT INTO `hurtownie` (pk,kod_hurtowni,miejscowość,ulica,numer_mieszkania,kod_pocztowy,gmina,powiat,województwo) VALUES
...
INSERT INTO `towary` (pk,nazwa,kod_producenta,opis,dostępność,cena_jedn_netto,cena_jedn_brutto,stawka_vat,status) VALUES
...
INSERT INTO `pracownicy` (pk,fk_umowy,fk_stanowiska,fk_hurtownie,imię,nazwisko,miejscowość,ulica,pesel,numer_mieszkania,kod_pocztowy,nip,numer_telefonu,drugie_imię,nazwa_użytkownika,hashowane_hasło,zatrudnienie)
 VALUES
...
(65,64,10,4,'Chrystian','Malejonek','Gnatowo','ul. Mylna',80062617343,163,'05-802',NULL,'310-156-663','Innocenty','hylezoca6urekarewezaq69ej','2E075BFAF68483FC0166824BC4549DEE',true),
...
INSERT INTO `zamówienia` (pk,fk_hurtownie,fk_dostawcy,fk_pracownicy,data_zlecenia,data_odbioru,cena_sum_netto,cena_sum_brutto) VALUES
(1,6,2,109,'2019-08-15 13:17:34','2019-08-18 09:12:15',62250.0,76567.5);
INSERT INTO `zamówienia` (pk,fk_hurtownie,fk_dostawcy,fk_pracownicy,data_zlecenia,data_odbioru,cena_sum_netto,cena_sum_brutto) VALUES
(2,3,5,50,'2018-09-16 14:28:09','2018-09-20 23:13:03',79220.0,97440.6);
INSERT INTO `zamówienia` (pk,fk_hurtownie,fk_dostawcy,fk_pracownicy,data_zlecenia,data_odbioru,cena_sum_netto,cena_sum_brutto) VALUES
(3,2,6,35,'2020-01-17 12:53:02','2020-01-21 07:30:41',165597.5,203684.93);
INSERT INTO `zamówienia` (pk,fk_hurtownie,fk_dostawcy,fk_pracownicy,data_zlecenia,data_odbioru,cena_sum_netto,cena_sum_brutto) VALUES
(4,1,7,10,'2018-10-30 09:47:29','2018-11-05 04:56:20',110485.0,135896.55);
INSERT INTO `zamówienia` (pk,fk_hurtownie,fk_dostawcy,fk_pracownicy,data_zlecenia,data_odbioru,cena_sum_netto,cena_sum_brutto) VALUES
(5,5,10,89,'2019-11-28 08:11:07','2020-01-02 15:20:58',75712.5,93126.38);

INSERT INTO `start_upy` (pk,miejscowość,ulica,numer_mieszkania,kod_pocztowy,nip,numer_telefonu,email,regon,nazwa,województwo,powiat,gmina) VALUES
...
INSERT INTO `fundacje` (pk,miejscowość,ulica,numer_mieszkania,kod_pocztowy,nip,numer_telefonu,email,regon,nazwa,województwo,powiat,gmina) VALUES
(1,'Maciejów','ul. Pana Tadeusza',177,'09-500','834-52-23-431','570-220-638','wyrokufubewis0kyposuha@pymosiwu4ymynuzipojamyl-pi3omixagiposegijyxexize6awewiten.pl',114160595,'Fundacja Batorego','małopolskie','sejneński','Słupia (Konecka)'),
...
INSERT INTO `dane_przedsiębiorstw` (pk,miejscowość,ulica,numer_mieszkania,kod_pocztowy,nip,numer_telefonu,email,regon,nazwa_przedsiębiorstwa,województwo,powiat,gmina) VALUES
...
(3,'Przewłoka','ul. Marmurowa',82,'13-220','557-43-73-171','907-034-109','my@6u6uwyvesywykitomocekitihikefovybijibozesyjorabuxavy.pl',784066207,'FastCode','wielkopolskie','m. Tychy','M. Lublin'),
...
INSERT INTO `punkty_sprzedaży` (pk,fk_dane_przedsiębiorstw,miejscowość,ulica,numer_mieszkania,kod_pocztowy,numer_telefonu,email,województwo,powiat,gmina,status) VALUES
(1,1,'Gołębiów','ul. Majkowskiego Aleksandra (Doktora Aleksandra Majkowskiego)',174,'42-360','453-981-686','nuderunokifatavuzu1otynaxugomiqo@t0fe5idip.pl','opolskie','lipnowski','Siewierz',true),
(2,2,'Rutkowice','ul. Świętego Brata Alberta',233,'86-307','267-429-560','nyjezele9uha1yhowyvimajyfaxuzegi@qodozomek4jozaq2q3sywofiz9k0rude.pl','mazowieckie','lubiński','Cewice',true),
(3,3,'Przewłoka','ul. Marmurowa',82,'13-220','146-966-693','my@6u6uwyvesywykitomocekitihikefovybijibozesyjorabuxavy.pl','wielkopolskie','m. Tychy','M. Lublin',true),
(4,4,'Nieborzyn','ul. Kacza',286,'98-290','991-458-343','zoc71@xevyfutif0kucyf.pl','kujawsko-pomorskie','m. Szczecin','Strachówka',true),
(5,5,'Mochle','ul. Konarskiego Stanisława',193,'05-077','402-446-009','bo.ytarepyqela7ezap5sizyve7oluk@cife1e.pl','mazowieckie','m. st. Warszawa','M. Bydgoszcz',true),
(6,6,'Opinogóra Górna','ul. Moniuszki Stanisława',39,'41-800','181-858-296','kavovu3yp0duhidimasov6@wyruhyra3ibovetujysykoge4osihuz6quq5.pl','dolnoŚląskie','koniński','M. Rzeszów',true),
(7,7,'Brodowa Góra','ul. Rokitniańska',120,'81-919','650-086-406','hamutazacudiwud05a4ylodig@lasepawiny7utyf2xezorihuto8omo2ifijiqetos2.pl','mazowieckie','polkowicki','M. Łódź',true),
(8,8,'Bydgoszcz','ul. Miarki Karola',26,'72-221','651-222-914','sak7hajycobobegapocizyzu@botyjosekekywozonekun3hu7uc1qowifu8ive9a56gavuzeruzopyvonup.pl','łódzkie','m. Lublin','Mykanów',true),
(9,9,'Józefów','ul. Z. Kościńskiego',95,'58-562','345-765-395','nak2joga@qohevoriqopasyhyvyzunemu6ehudu08q5jycewixuky.pl','kujawsko-pomorskie','Średzki','Chorzele',true),
(10,10,'Władysławowo','ul. Staffa Leopolda',168,'05-085','950-182-967','8ybohe2ejeryrofy@mapopu3emirejon.pl','wielkopolskie','dębicki','Radomin',true),
(11,1,'Modryń-Kolonia','ul. Zaciszna',35,'85-001','937-032-461','serovyfelirumicufynuxu@3az5liraz.pl','warmińsko-mazurskie','tomaszowski','M. st. Warszawa',true),
(12,1,'Olsztyn','ul. Rabatki',280,'74-120','489-884-619','1i5azyhujiji01wotudesa@4a.pl','dolnośląskie','m. Katowice','Brańsk',true),
(13,2,'Goruszów','ul. Kaliska',247,'03-578','474-281-909','seno2oluhip5gucimec9sohuvys@6onylikaxe0ori5e-afupiqetyluwilabu-erez39ocetypimykihito.pl','wielkopolskie','czêstochowski','Przerośl',true),
(14,2,'Poznań','ul. Toruńska',96,'86-105','751-025-492','1osazad.jusisymomasi3ahize@6ejepuhizepe8e4ujuvodu-emad6kekymi.pl','śląskie','sochaczewski','M. Bielsko-Biała',true),
(15,4,'Wałbrzych','ul. Staszica Stanisława',183,'02-203','962-261-707','ficixa2osegolodacu@1ozimaposydyhun2jynapuw0lukumysuxy8irypeh8c1zojaquz.pl','mazowieckie','pleszewski','Wilamowice',true),
(16,5,'Jaworzno','ul. Poziomkowa',240,'61-441','921-249-078','bypebesetywis5de@nelogosiqafanugufuly41we.pl','mazowieckie','pabianicki','Bobolice',true),
(17,5,'Rybnik','ul. Partyzantów',227,'04-608','989-814-684','fogifebod@4efusyv2.pl','mazowieckie','m. Włocławek','Kłaj',true),
(18,7,'Wylan','ul. Galileusza',6,'70-767','318-304-946','qyny.ovonop@4udyp.pl','śląskie','wodzisławski','świecie',true),
(19,9,'Jasieniec Solecki','ul. Zaciszna',156,'02-760','474-808-310','relerudugojozod9rav@jyd7k75ytesedyzy3umyjalupyryso.pl','warmińsko-mazurskie','m. Grudziądz','M. Bielsko-Biała',true),
(20,8,'Kozielsko','ul. Nasypowa',3,'45-527','195-933-932','ne1imocuz5toky@ci5yl0s1k4bukejisi9i0acyzany.pl','mazowieckie','zawierciański','M. Kraków',true);

INSERT INTO `kategorie` (pk,kategoria,fk_podkategorii) VALUES
...
(1,1,1,'2020.02.02 10:00:00','2020.02.03 10:00:00',667500.0,821025.0,0.2),
(2,4,5,'2020.02.16 10:05:11','2020.02.17 10:05:11',494200.0,607866.0,0.0),
(3,4,10,'2020.02.17 10:11:30','2020.02.18 10:11:30',571400.0,702822.0,0.1),
(4,4,15,'2020.02.21 10:15:35','2020.02.22 10:15:35',691050.0,849991.5,0.2),
(5,1,13,'2020.03.02 10:00:59','2020.03.03 10:00:59',805300.0,990519.0,0.3);
...
INSERT INTO `stanowiska_uprawnienia` (pk,fk_stanowiska,fk_uprawnienia) VALUES
(1,1,1),
(2,1,3),
(3,1,7),
(4,1,12),
...
INSERT INTO `towary_kategorie` (pk,fk_towary,fk_kategorie_towaru) VALUES
(1,1,1),
(2,2,1),
(3,3,1),
(4,4,1),
...
(1,1,1,25.0,30.75,100),
(2,1,3,35.0,43.05,200),
(3,1,5,45.0,55.35,300),
(4,1,7,32.0,39.98,400),
(5,1,8,37.0,46.13,700),
(6,2,2,30.0,36.9,200),
(7,2,3,35.0,43.05,600),
(8,2,4,40.0,49.2,666),
(9,2,5,45.0,55.35,500),
(10,2,6,27.5,33.83,112),
(11,3,7,32.5,39.98,997),
(12,3,8,37.5,46.13,998),
(13,3,2,30.0,36.9,999),
(14,3,3,35,43.05,992),
(15,3,4,40,49.2,777),
(16,4,5,45,55.35,121),
